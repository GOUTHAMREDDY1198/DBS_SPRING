...
public class Client {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Student stu1 = new Student(1, "Goutham", "K", teachers);
			Student stu2 = new Student(2, "Nani", "J", teachers);
			students.add(stu1);
			students.add(stu2);

			Teacher tch1 = new Teacher(1, "Sir", "K", students);
			Teacher tch2 = new Teacher(2, "Madam", "K", students);
			teachers.add(tch1);
			teachers.add(tch2);
